export const translations = {
    vi: {
        ...
        hero: {
            ...
            bio: {
                p1: "Chào các bạn mình là sinh viên đã tốt nghiệp ngành ",
                csHighlight: "Khoa học Máy tính",
                p2: " tại Đại học Duy Tân, với nền tảng vững chắc về lập trình và tư duy giải quyết vấn đề. Trong quá trình học tập và làm việc, mình đã tích lũy kinh nghiệm thực tế ở vai trò ",
                rolesHighlight: "Fullstack Developer, AI Engineer và ML Engineer",
                p3: ", từ việc xây dựng ứng dụng web hoàn chỉnh đến huấn luyện và triển khai các mô hình học máy vào các sản phẩm thực tế. Mình yêu thích việc kết hợp giữa phát triển phần mềm và trí tuệ nhân tạo để tạo ra những sản phẩm vừa có kiến trúc tốt, vừa mang lại giá trị thông minh cho người dùng. Hiện tại, mình vẫn đang tiếp tục trau dồi kỹ năng và tìm kiếm cơ hội việc làm cho bản thân để áp dụng những gì mình học được vào các dự án thực tế.",
            },
            btnProjects: "Dự án",
            btnSkills: "Kỹ năng",
            btnContact: "Liên hệ",
